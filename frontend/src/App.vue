  ...
  <div ref="socialMenuContainer" class="fixed bottom-6 right-6 lg:left-6 lg:right-auto z-50">
    ...
    <div class="lg:hidden flex flex-col-reverse items-center space-y-4">
      <div v-if="isSocialMenuOpen"
        ...
        <a href="https://www.linkedin.com/in/ksohamdev/" class="text-black hover:opacity-70 transition-opacity" target="_blank"><i
            class="ri-linkedin-line text-3xl"></i></a>
        ...
        <a href="#" class="text-black hover:opacity-70 transition-opacity" target="_blank"><i class="ri-chat-ai-line text-3xl"></i></a>
      </div>
    ...
    <div class="hidden lg:flex items-center space-x-4">
      <a href="https://github.com/KSoham-dev"
        class="w-14 h-14 bg-white/75 backdrop-blur-lg rounded-full shadow-md border-2 border-black flex items-center justify-center text-black hover:opacity-70 transition-opacity" target="_blank">
